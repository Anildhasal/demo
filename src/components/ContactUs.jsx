...
const ContactUs = () => {
    ...
    formData.append("access_key", "c536f90a-47fd-4f1e-a03d-9c49cb3572d9");
  ...
  return (
    <div id='contact-us' className='flex flex-col items-center gap-7
    ...
    <Title title='Reach out us'desc='From strategy to execution,we craft
     digital solution that move your business foward'/>
     ...
     <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
        ...
        <div>
            ...
            dark:border-gray-600'>
                ...
                <input name="name" placeholder='Enter your name' className='w-full
        ...
        <div>
         ...
         <div className='sm:col-span-2'>
           <p className='mb-text-sm font-medium'>Message</p>
